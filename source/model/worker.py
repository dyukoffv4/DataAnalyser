...
class Worker:
    def __init__(self, sheet, from_column, to_column, res_columns: dict):
        ...
        for i in range(2, len(sheet[to_column])):  # todo: Risk of 1'st string
            if sheet[f'{to_column}{i}'].value is None:
                break
